...
import { validateEmail, validatePassword, getTime } from "./../helpers/helpers";
      ...
      <div className="image-background">
        <div className="container m-4">
          <div className="row">
            ...
            <div className="col-sm-9 shadow-effect">
              <h1 className="formHeading">CREATE A DEADLINE ACCOUNT</h1>
